namespace PlotlyBridge
{
    ...
    public static partial class Sunburst
    {
        ...
        public static Box<ISunburstProperty> count(params Box<ISunburstProperty>[] properties) => Interop.mkSunburstAttr("count", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<ISunburstProperty> textinfo(params Box<ISunburstProperty>[] properties) => Interop.mkSunburstAttr("textinfo", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<ISunburstProperty> hoverinfo(params Box<ISunburstProperty>[] properties) => Interop.mkSunburstAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
