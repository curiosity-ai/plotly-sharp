namespace PlotlyBridge
{
    ...
    public static partial class Candlestick
    {
        ...
        public static Box<ICandlestickProperty> hoverinfo(params Box<ICandlestickProperty>[] properties) => Interop.mkCandlestickAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
