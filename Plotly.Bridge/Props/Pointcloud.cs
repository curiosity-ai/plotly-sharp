namespace PlotlyBridge
{
    ...
    public static partial class Pointcloud
    {
        ...
        public static Box<IPointcloudProperty> hoverinfo(params Box<IPointcloudProperty>[] properties) => Interop.mkPointcloudAttr("hoverinfo", Bindings.joinEnumProperties(properties));
