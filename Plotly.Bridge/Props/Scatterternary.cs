namespace PlotlyBridge
{
    ...
    public static partial class Scatterternary
    {
        ...
        public static Box<IScatterternaryProperty> mode(params Box<IScatterternaryProperty>[] properties) => Interop.mkScatterternaryAttr("mode", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IScatterternaryProperty> hoverinfo(params Box<IScatterternaryProperty>[] properties) => Interop.mkScatterternaryAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
        /// Do the hover effects highlight individual points (markers or line points) or do they highlight filled regions? If the fill is *toself* or *tonext* and there are no markers or text, then the default is *fills*, otherwise it is *points*.
        public static Box<IScatterternaryProperty> hoveron(params Box<IScatterternaryProperty>[] properties) => Interop.mkScatterternaryAttr("hoveron", Script.Write<object>("{0}.join('+')", properties));
