namespace PlotlyBridge
{
    ...
    public static partial class Barpolar
    {
        ...
        public static Box<IBarpolarProperty> hoverinfo(params Box<IBarpolarProperty>[] properties) => Interop.mkBarpolarAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
