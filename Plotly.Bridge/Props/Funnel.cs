namespace PlotlyBridge
{
    ...
    public static partial class Funnel
    {
        ...
        public static Box<IFunnelProperty> hoverinfo(params Box<IFunnelProperty>[] properties) => Interop.mkFunnelAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IFunnelProperty> textinfo(params Box<IFunnelProperty>[] properties) => Interop.mkFunnelAttr("textinfo", Script.Write<object>("{0}.join('+')", properties));
