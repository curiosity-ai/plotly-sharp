namespace PlotlyBridge
{
    ...
    public static partial class Pie
    {
        ...
        public static Box<IPieProperty> textinfo(params Box<IPieProperty>[] properties) => Interop.mkPieAttr("textinfo", Script.Write<object>("{0}.join('+')", properties));
        /// Determines which trace information appear on hover. If `none` or `skip` are set, no information is displayed upon hovering. But, if `none` is set, click and hover events are still fired.
        public static Box<IPieProperty> hoverinfo(params Box<IPieProperty>[] properties) => Interop.mkPieAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
