namespace PlotlyBridge
{
    ...
    public static partial class Waterfall
    {
        ...
        public static Box<IWaterfallProperty> hoverinfo(params Box<IWaterfallProperty>[] properties) => Interop.mkWaterfallAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IWaterfallProperty> textinfo(params Box<IWaterfallProperty>[] properties) => Interop.mkWaterfallAttr("textinfo", Script.Write<object>("{0}.join('+')", properties));
