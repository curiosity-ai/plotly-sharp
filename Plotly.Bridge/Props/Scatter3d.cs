namespace PlotlyBridge
{
    ...
    public static partial class Scatter3d
    {
        ...
        public static Box<IScatter3dProperty> mode(params Box<IScatter3dProperty>[] properties) => Interop.mkScatter3dAttr("mode", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IScatter3dProperty> hoverinfo(params Box<IScatter3dProperty>[] properties) => Interop.mkScatter3dAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
