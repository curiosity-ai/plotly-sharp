namespace PlotlyBridge
{
    ...
    public static partial class Scatter
    {
        ...
        public static Box<IScatterProperty> hoverinfo(params Box<IScatterProperty>[] properties) => Interop.mkScatterAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IScatterProperty> mode(params Box<IScatterProperty>[] properties) => Interop.mkScatterAttr("mode", Script.Write<object>("{0}.join('+')", properties));
        /// Do the hover effects highlight individual points (markers or line points) or do they highlight filled regions? If the fill is *toself* or *tonext* and there are no markers or text, then the default is *fills*, otherwise it is *points*.
        public static Box<IScatterProperty> hoveron(params Box<IScatterProperty>[] properties) => Interop.mkScatterAttr("hoveron", Script.Write<object>("{0}.join('+')", properties));
