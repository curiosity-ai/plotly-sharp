namespace PlotlyBridge
{
    ...
    public static partial class Treemap
    {
        ...
        public static Box<ITreemapProperty> count(params Box<ITreemapProperty>[] properties) => Interop.mkTreemapAttr("count", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<ITreemapProperty> textinfo(params Box<ITreemapProperty>[] properties) => Interop.mkTreemapAttr("textinfo", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<ITreemapProperty> hoverinfo(params Box<ITreemapProperty>[] properties) => Interop.mkTreemapAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
