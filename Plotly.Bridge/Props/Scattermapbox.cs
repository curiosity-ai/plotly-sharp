namespace PlotlyBridge
{
    ...
    public static partial class Scattermapbox
    {
        ...
        public static Box<IScattermapboxProperty> mode(params Box<IScattermapboxProperty>[] properties) => Interop.mkScattermapboxAttr("mode", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IScattermapboxProperty> hoverinfo(params Box<IScattermapboxProperty>[] properties) => Interop.mkScattermapboxAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
