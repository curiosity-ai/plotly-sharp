namespace PlotlyBridge
{
    ...
    public static partial class Scattergeo
    {
        ...
        public static Box<IScattergeoProperty> mode(params Box<IScattergeoProperty>[] properties) => Interop.mkScattergeoAttr("mode", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IScattergeoProperty> hoverinfo(params Box<IScattergeoProperty>[] properties) => Interop.mkScattergeoAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
