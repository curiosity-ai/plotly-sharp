namespace PlotlyBridge
{
    ...
    public static partial class Scatterpolar
    {
        ...
        public static Box<IScatterpolarProperty> mode(params Box<IScatterpolarProperty>[] properties) => Interop.mkScatterpolarAttr("mode", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IScatterpolarProperty> hoverinfo(params Box<IScatterpolarProperty>[] properties) => Interop.mkScatterpolarAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
        /// Do the hover effects highlight individual points (markers or line points) or do they highlight filled regions? If the fill is *toself* or *tonext* and there are no markers or text, then the default is *fills*, otherwise it is *points*.
        public static Box<IScatterpolarProperty> hoveron(params Box<IScatterpolarProperty>[] properties) => Interop.mkScatterpolarAttr("hoveron", Script.Write<object>("{0}.join('+')", properties));
