namespace PlotlyBridge
{
    ...
    public static partial class Choroplethmapbox
    {
        ...
        public static Box<IChoroplethmapboxProperty> hoverinfo(params Box<IChoroplethmapboxProperty>[] properties) => Interop.mkChoroplethmapboxAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
