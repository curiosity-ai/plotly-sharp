namespace PlotlyBridge
{
    ...
    public static partial class Scattercarpet
    {
        ...
        public static Box<IScattercarpetProperty> mode(params Box<IScattercarpetProperty>[] properties) => Interop.mkScattercarpetAttr("mode", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IScattercarpetProperty> hoverinfo(params Box<IScattercarpetProperty>[] properties) => Interop.mkScattercarpetAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
        /// Do the hover effects highlight individual points (markers or line points) or do they highlight filled regions? If the fill is *toself* or *tonext* and there are no markers or text, then the default is *fills*, otherwise it is *points*.
        public static Box<IScattercarpetProperty> hoveron(params Box<IScattercarpetProperty>[] properties) => Interop.mkScattercarpetAttr("hoveron", Script.Write<object>("{0}.join('+')", properties));
