namespace PlotlyBridge
{
    ...
    public static partial class Choropleth
    {
        ...
        public static Box<IChoroplethProperty> hoverinfo(params Box<IChoroplethProperty>[] properties) => Interop.mkChoroplethAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
