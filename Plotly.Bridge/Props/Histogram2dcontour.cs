namespace PlotlyBridge
{
    ...
    public static partial class Histogram2dcontour
    {
        ...
        public static Box<IHistogram2dcontourProperty> hoverinfo(params Box<IHistogram2dcontourProperty>[] properties) => Interop.mkHistogram2dcontourAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
