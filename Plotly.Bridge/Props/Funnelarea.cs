namespace PlotlyBridge
{
    ...
    public static partial class Funnelarea
    {
        ...
        public static Box<IFunnelareaProperty> textinfo(params Box<IFunnelareaProperty>[] properties) => Interop.mkFunnelareaAttr("textinfo", Script.Write<object>("{0}.join('+')", properties));
        ...
        public static Box<IFunnelareaProperty> hoverinfo(params Box<IFunnelareaProperty>[] properties) => Interop.mkFunnelareaAttr("hoverinfo", Script.Write<object>("{0}.join('+')", properties));
