namespace Plotly
{
    ...
    public static partial class Traces
    {
        ...
        public static Box<ITracesProperty> icicle(params Box<IIcicleProperty>[] properties) => Interop.mkTracesAttr("icicle", Bindings.flattenProperties(properties.Concat(new[] { Interop.mkIcicleAttr("type", "icicle") })));
