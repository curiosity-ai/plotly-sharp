namespace Plotly
{
    ...
    public static partial class Link
    {
        ...
        /// The shown name of the link.
        public static Box<ILinkProperty> label(IEnumerable<string> values) => Interop.mkLinkAttr("label", values.ToArray());
        /// The shown name of the link.
        ...
        public static Box<ILinkProperty> customdata(bool val) => Interop.mkLinkAttr("customdata", new[] { val });
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<bool> values) => Interop.mkLinkAttr("customdata", values.ToArray());
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(System.DateTime val) => Interop.mkLinkAttr("customdata", new[] { val });
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<System.DateTime> values) => Interop.mkLinkAttr("customdata", values.ToArray());
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(float val) => Interop.mkLinkAttr("customdata", new[] { val });
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<float> values) => Interop.mkLinkAttr("customdata", values.ToArray());
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(int val) => Interop.mkLinkAttr("customdata", new[] { val });
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<int> values) => Interop.mkLinkAttr("customdata", values.ToArray());
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(string val) => Interop.mkLinkAttr("customdata", new[] { val });
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<string> values) => Interop.mkLinkAttr("customdata", values.ToArray());
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<bool[]> values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(List<bool[]> values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(params bool[][] values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<IEnumerable<string>> values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(List<string[]> values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(params string[][] values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<IEnumerable<int>> values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(List<int[]> values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(params int[][] values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<IEnumerable<float>> values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(List<float[]> values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(params float[][] values) => Interop.mkLinkAttr("customdata", Bindings.flatten2DArrayIf1D(values));
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(Literals.PlotData[] values) => Interop.mkLinkAttr("customdata", values);
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<bool?> values) => Interop.mkLinkAttr("customdata", values.ToArray());
        /// Assigns extra data to each link.
        public static Box<ILinkProperty> customdata(IEnumerable<System.DateTime?> values) => Interop.mkLinkAttr("customdata", values.ToArray());
        ...
        /// An integer number `[0..nodes.length - 1]` that represents the source node.
        public static Box<ILinkProperty> source(IEnumerable<string> values) => Interop.mkLinkAttr("source", values.ToArray());
        /// An integer number `[0..nodes.length - 1]` that represents the source node.
        ...
        /// An integer number `[0..nodes.length - 1]` that represents the target node.
        public static Box<ILinkProperty> target(IEnumerable<string> values) => Interop.mkLinkAttr("target", values.ToArray());
        /// An integer number `[0..nodes.length - 1]` that represents the target node.
        ...
        /// A numeric value representing the flow volume value.
        public static Box<ILinkProperty> value(IEnumerable<string> values) => Interop.mkLinkAttr("value", values.ToArray());
        /// A numeric value representing the flow volume value.
        ...
        public static Box<ILinkProperty> customdatasrc(string val) => Interop.mkLinkAttr("customdatasrc", val);
