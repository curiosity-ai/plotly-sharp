namespace Plotly
{
    ...
    public static partial class Layout
    {
        ...
        public static Box<ILayoutProperty> clickmode(params Box<ILayoutProperty>[] properties) => Interop.mkLayoutAttr("clickmode", Bindings.joinEnumProperties(properties));
