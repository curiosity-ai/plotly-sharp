namespace Transpose.Plotly
{
    ...
    public static partial class Histogram2d
    {
        ...
        public static Box<IHistogram2dProperty> legendgroup(string val) => Interop.mkHistogram2dAttr("legendgroup", val);
        public static Box<IHistogram2dProperty> legendgrouptitle(params Box<ILegendgrouptitleProperty>[] properties) => Interop.mkHistogram2dAttr("legendgrouptitle", Bindings.flattenProperties(properties));
        /// Sets the legend rank for this trace. Items and groups with smaller ranks are presented on top/left side while with `*reversed* `legend.traceorder` they are on bottom/right side. The default legendrank is 1000, so that you can use ranks less than 1000 to place certain items before all unranked items, and ranks greater than 1000 to go after all unranked items.
        public static Box<IHistogram2dProperty> legendrank(int val) => Interop.mkHistogram2dAttr("legendrank", val);
        /// Sets the legend rank for this trace. Items and groups with smaller ranks are presented on top/left side while with `*reversed* `legend.traceorder` they are on bottom/right side. The default legendrank is 1000, so that you can use ranks less than 1000 to place certain items before all unranked items, and ranks greater than 1000 to go after all unranked items.
        public static Box<IHistogram2dProperty> legendrank(float val) => Interop.mkHistogram2dAttr("legendrank", val);
        ...
        /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
        public static Box<IHistogram2dProperty> ids(IEnumerable<string> values) => Interop.mkHistogram2dAttr("ids", values.ToArray());
        /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
        ...
        /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
        public static Box<IHistogram2dProperty> customdata(IEnumerable<string> values) => Interop.mkHistogram2dAttr("customdata", values.ToArray());
        /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
        ...
        /// Sets the aggregation data.
        public static Box<IHistogram2dProperty> z(IEnumerable<string> values) => Interop.mkHistogram2dAttr("z", values.ToArray());
        /// Sets the aggregation data.
        ...
        public static Box<IHistogram2dProperty> xhoverformat(string val) => Interop.mkHistogram2dAttr("xhoverformat", val);
        /// Sets the hover text formatting rulefor `y`  using d3 formatting mini-languages which are very similar to those in Python. For numbers, see: https://github.com/d3/d3-3.x-api-reference/blob/master/Formatting.md#d3_format. And for dates see: https://github.com/d3/d3-time-format#locale_format. We add two items to d3's date formatter: *%h* for half of the year as a decimal number as well as *%{n}f* for fractional seconds with n digits. For example, *2016-10-13 09:15:23.456* with tickformat *%H~%M~%S.%2f* would display *09~15~23.46*By default the values are formatted using `yaxis.hoverformat`.
        public static Box<IHistogram2dProperty> yhoverformat(string val) => Interop.mkHistogram2dAttr("yhoverformat", val);
        ...
        public static Box<IHistogram2dProperty> showlegend(bool val) => Interop.mkHistogram2dAttr("showlegend", val);
