namespace PlotlyH5
{
    ...
    public static partial class Choroplethmapbox
    {
        ...
        public static Box<IChoroplethmapboxProperty> legendgrouptitle(params Box<ILegendgrouptitleProperty>[] properties) => Interop.mkChoroplethmapboxAttr("legendgrouptitle", Bindings.flattenProperties(properties));
        /// Sets the legend rank for this trace. Items and groups with smaller ranks are presented on top/left side while with `*reversed* `legend.traceorder` they are on bottom/right side. The default legendrank is 1000, so that you can use ranks less than 1000 to place certain items before all unranked items, and ranks greater than 1000 to go after all unranked items.
        public static Box<IChoroplethmapboxProperty> legendrank(int val) => Interop.mkChoroplethmapboxAttr("legendrank", val);
        /// Sets the legend rank for this trace. Items and groups with smaller ranks are presented on top/left side while with `*reversed* `legend.traceorder` they are on bottom/right side. The default legendrank is 1000, so that you can use ranks less than 1000 to place certain items before all unranked items, and ranks greater than 1000 to go after all unranked items.
        public static Box<IChoroplethmapboxProperty> legendrank(float val) => Interop.mkChoroplethmapboxAttr("legendrank", val);
        ...
        /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
        public static Box<IChoroplethmapboxProperty> ids(IEnumerable<string> values) => Interop.mkChoroplethmapboxAttr("ids", values.ToArray());
        /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
        ...
        /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
        public static Box<IChoroplethmapboxProperty> customdata(IEnumerable<string> values) => Interop.mkChoroplethmapboxAttr("customdata", values.ToArray());
        /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
        ...
        /// Sets which features found in *geojson* to plot using their feature `id` field.
        public static Box<IChoroplethmapboxProperty> locations(IEnumerable<string> values) => Interop.mkChoroplethmapboxAttr("locations", values.ToArray());
        /// Sets which features found in *geojson* to plot using their feature `id` field.
        ...
        /// Sets the color values.
        public static Box<IChoroplethmapboxProperty> z(IEnumerable<string> values) => Interop.mkChoroplethmapboxAttr("z", values.ToArray());
        /// Sets the color values.
