namespace PlotlyH5
{
    ...
    public static partial class Histogram
    {
        ...
        public static Box<IHistogramProperty> hoverinfo(params Box<IHistogramProperty>[] properties) => Interop.mkHistogramAttr("hoverinfo", Bindings.joinEnumProperties(properties));
