namespace PlotlyH5
{
    ...
    {
        public static Box<ICarpetProperty> legendgrouptitle(params Box<ILegendgrouptitleProperty>[] properties) => Interop.mkCarpetAttr("legendgrouptitle", Bindings.flattenProperties(properties));
        /// Sets the legend rank for this trace. Items and groups with smaller ranks are presented on top/left side while with `*reversed* `legend.traceorder` they are on bottom/right side. The default legendrank is 1000, so that you can use ranks less than 1000 to place certain items before all unranked items, and ranks greater than 1000 to go after all unranked items.
        public static Box<ICarpetProperty> legendrank(int val) => Interop.mkCarpetAttr("legendrank", val);
        /// Sets the legend rank for this trace. Items and groups with smaller ranks are presented on top/left side while with `*reversed* `legend.traceorder` they are on bottom/right side. The default legendrank is 1000, so that you can use ranks less than 1000 to place certain items before all unranked items, and ranks greater than 1000 to go after all unranked items.
        public static Box<ICarpetProperty> legendrank(float val) => Interop.mkCarpetAttr("legendrank", val);
        ...
        /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
        public static Box<ICarpetProperty> ids(IEnumerable<string> values) => Interop.mkCarpetAttr("ids", values.ToArray());
        /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
        ...
        /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
        public static Box<ICarpetProperty> customdata(IEnumerable<string> values) => Interop.mkCarpetAttr("customdata", values.ToArray());
        /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
        ...
        /// An array containing values of the first parameter value
        public static Box<ICarpetProperty> a(IEnumerable<string> values) => Interop.mkCarpetAttr("a", values.ToArray());
        /// An array containing values of the first parameter value
        ...
        /// A two dimensional array of y coordinates at each carpet point.
        public static Box<ICarpetProperty> b(IEnumerable<string> values) => Interop.mkCarpetAttr("b", values.ToArray());
        /// A two dimensional array of y coordinates at each carpet point.
