...
namespace Tesserae.Plotly
{
    ...
    public static class Bindings
    {
        ...
        private class PlotlyPlot :IPlot
        {
            ...
            private static void BindPlotlyEvents(object props, HTMLElement container) => Bindings.BindPlotlyEvents(props, container);
        }

        internal static void BindPlotlyEvents(object props, HTMLElement container)
        {
