namespace Tesserae.Plotly
{
    ...
    public static partial class Funnel
    {
        ...
        public static Box<IFunnelProperty> legendgrouptitle(params Box<ILegendgrouptitleProperty>[] properties) => Interop.mkFunnelAttr("legendgrouptitle", Bindings.flattenProperties(properties));
        /// Sets the legend rank for this trace. Items and groups with smaller ranks are presented on top/left side while with `*reversed* `legend.traceorder` they are on bottom/right side. The default legendrank is 1000, so that you can use ranks less than 1000 to place certain items before all unranked items, and ranks greater than 1000 to go after all unranked items.
        public static Box<IFunnelProperty> legendrank(int val) => Interop.mkFunnelAttr("legendrank", val);
        /// Sets the legend rank for this trace. Items and groups with smaller ranks are presented on top/left side while with `*reversed* `legend.traceorder` they are on bottom/right side. The default legendrank is 1000, so that you can use ranks less than 1000 to place certain items before all unranked items, and ranks greater than 1000 to go after all unranked items.
        public static Box<IFunnelProperty> legendrank(float val) => Interop.mkFunnelAttr("legendrank", val);
        ...
        /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
        public static Box<IFunnelProperty> ids(IEnumerable<string> values) => Interop.mkFunnelAttr("ids", values.ToArray());
        /// Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an array of strings, not numbers or any other type.
        ...
        /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
        public static Box<IFunnelProperty> customdata(IEnumerable<string> values) => Interop.mkFunnelAttr("customdata", values.ToArray());
        /// Assigns extra data each datum. This may be useful when listening to hover, click and selection events. Note that, *scatter* traces also appends customdata items in the markers DOM elements
        ...
        public static Box<IFunnelProperty> xperiod(bool val) => Interop.mkFunnelAttr("xperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(params bool[] values) => Interop.mkFunnelAttr("xperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(System.DateTime val) => Interop.mkFunnelAttr("xperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(params System.DateTime[] values) => Interop.mkFunnelAttr("xperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(int val) => Interop.mkFunnelAttr("xperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(params int[] values) => Interop.mkFunnelAttr("xperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(float val) => Interop.mkFunnelAttr("xperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(params float[] values) => Interop.mkFunnelAttr("xperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(string val) => Interop.mkFunnelAttr("xperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the x axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> xperiod(params string[] values) => Interop.mkFunnelAttr("xperiod", values);
        ...
        public static Box<IFunnelProperty> yperiod(bool val) => Interop.mkFunnelAttr("yperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(params bool[] values) => Interop.mkFunnelAttr("yperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(System.DateTime val) => Interop.mkFunnelAttr("yperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(params System.DateTime[] values) => Interop.mkFunnelAttr("yperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(int val) => Interop.mkFunnelAttr("yperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(params int[] values) => Interop.mkFunnelAttr("yperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(float val) => Interop.mkFunnelAttr("yperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(params float[] values) => Interop.mkFunnelAttr("yperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(string val) => Interop.mkFunnelAttr("yperiod", val);
        /// Only relevant when the axis `type` is *date*. Sets the period positioning in milliseconds or *M<n>* on the y axis. Special values in the form of *M<n>* could be used to declare the number of months. In this case `n` must be a positive integer.
        public static Box<IFunnelProperty> yperiod(params string[] values) => Interop.mkFunnelAttr("yperiod", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(bool val) => Interop.mkFunnelAttr("xperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(params bool[] values) => Interop.mkFunnelAttr("xperiod0", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(System.DateTime val) => Interop.mkFunnelAttr("xperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(params System.DateTime[] values) => Interop.mkFunnelAttr("xperiod0", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(int val) => Interop.mkFunnelAttr("xperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(params int[] values) => Interop.mkFunnelAttr("xperiod0", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(float val) => Interop.mkFunnelAttr("xperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(params float[] values) => Interop.mkFunnelAttr("xperiod0", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(string val) => Interop.mkFunnelAttr("xperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the x0 axis. When `x0period` is round number of weeks, the `x0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> xperiod0(params string[] values) => Interop.mkFunnelAttr("xperiod0", values);
        ...
        public static Box<IFunnelProperty> yperiod0(bool val) => Interop.mkFunnelAttr("yperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(params bool[] values) => Interop.mkFunnelAttr("yperiod0", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(System.DateTime val) => Interop.mkFunnelAttr("yperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(params System.DateTime[] values) => Interop.mkFunnelAttr("yperiod0", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(int val) => Interop.mkFunnelAttr("yperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(params int[] values) => Interop.mkFunnelAttr("yperiod0", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(float val) => Interop.mkFunnelAttr("yperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(params float[] values) => Interop.mkFunnelAttr("yperiod0", values);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(string val) => Interop.mkFunnelAttr("yperiod0", val);
        /// Only relevant when the axis `type` is *date*. Sets the base for period positioning in milliseconds or date string on the y0 axis. When `y0period` is round number of weeks, the `y0period0` by default would be on a Sunday i.e. 2000-01-02, otherwise it would be at 2000-01-01.
        public static Box<IFunnelProperty> yperiod0(params string[] values) => Interop.mkFunnelAttr("yperiod0", values);
        /// Sets the hover text formatting rulefor `x`  using d3 formatting mini-languages which are very similar to those in Python. For numbers, see: https://github.com/d3/d3-3.x-api-reference/blob/master/Formatting.md#d3_format. And for dates see: https://github.com/d3/d3-time-format#locale_format. We add two items to d3's date formatter: *%h* for half of the year as a decimal number as well as *%{n}f* for fractional seconds with n digits. For example, *2016-10-13 09:15:23.456* with tickformat *%H~%M~%S.%2f* would display *09~15~23.46*By default the values are formatted using `xaxis.hoverformat`.
        public static Box<IFunnelProperty> xhoverformat(string val) => Interop.mkFunnelAttr("xhoverformat", val);
        /// Sets the hover text formatting rulefor `y`  using d3 formatting mini-languages which are very similar to those in Python. For numbers, see: https://github.com/d3/d3-3.x-api-reference/blob/master/Formatting.md#d3_format. And for dates see: https://github.com/d3/d3-time-format#locale_format. We add two items to d3's date formatter: *%h* for half of the year as a decimal number as well as *%{n}f* for fractional seconds with n digits. For example, *2016-10-13 09:15:23.456* with tickformat *%H~%M~%S.%2f* would display *09~15~23.46*By default the values are formatted using `yaxis.hoverformat`.
        public static Box<IFunnelProperty> yhoverformat(string val) => Interop.mkFunnelAttr("yhoverformat", val);
    ...
    public static partial class Funnel
    {
        ...
        {
            public static Box<IFunnelProperty> _end() => Interop.mkFunnelAttr("xperiodalignment", "end");
            public static Box<IFunnelProperty> middle() => Interop.mkFunnelAttr("xperiodalignment", "middle");
            public static Box<IFunnelProperty> start() => Interop.mkFunnelAttr("xperiodalignment", "start");
        }

        /// Only relevant when the axis `type` is *date*. Sets the alignment of data points on the y axis.
        public static partial class Yperiodalignment
        {
            public static Box<IFunnelProperty> _end() => Interop.mkFunnelAttr("yperiodalignment", "end");
            public static Box<IFunnelProperty> middle() => Interop.mkFunnelAttr("yperiodalignment", "middle");
            public static Box<IFunnelProperty> start() => Interop.mkFunnelAttr("yperiodalignment", "start");
        }
